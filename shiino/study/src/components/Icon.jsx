...
const SHAPES = {
  ...
  // トロフィー。カップ・脚・台の3つだけで描く
  trophy: (
    <>
      <path d="M3.6 2.8 H12.4 V5.6 C12.4 8.2 10.4 9.8 8 9.8 C5.6 9.8 3.6 8.2 3.6 5.6 Z" />
      <path d="M8 9.8 V12.4" />
      <path d="M5 13.4 H11" />
    </>
  ),
  ...
  lock: (
    <>
      ...
      <path d="M5.4 7 V5 C5.4 3.5 6.5 2.4 8 2.4 C9.5 2.4 10.6 3.5 10.6 5 V7" />
      <path d="M8 9.8 V11.2" />
    </>
  ),
  // 鉛筆（手入力）
